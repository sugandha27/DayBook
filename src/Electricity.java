 ...
 * @author sugandha
 */
public class Electricity extends javax.swing.JInternalFrame {
    ...
    String username;
    Connection x;
    public Electricity(String username,Connection x) {
        initComponents();
             ...
             y1.setString(1,details);
              ...
              System.out.println(y);
               ...
               int n=y.executeUpdate();
                ...
                int val=0;
                if(n>0)
                   st="Electricity bill paid on "+tdate+" amount to "+amt;
