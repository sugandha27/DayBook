...
public class expense extends javax.swing.JInternalFrame {
    ...
    private void btnHeadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHeadActionPerformed
       ...
       String l_name=txtlname.getText();
        ...
        {
             ex.printStackTrace();
            JOptionPane.showMessageDialog(this,"Ledger name cannot be modified");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this,"This ledger head cannot be deleted because it contains entries.");
        }
         showDetails();
         txtlname.setText("");
         txtldetails.setText("");
