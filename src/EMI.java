 ...
 * @author sugandha
 */
public class EMI extends javax.swing.JInternalFrame {
    ...
    String username;
    Connection x;
    public EMI(String username,Connection x) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Bill Payment", jPanel1);
             ...
             y1.setString(1,details);
              ...
              System.out.println(y);
               ...
               int n=y.executeUpdate();
                ...
                int val=0;
                if(n>0)
                   st="Monthly EMI bill paid on "+tdate+" amount to "+amt;
